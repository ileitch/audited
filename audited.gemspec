...
Gem::Specification.new do |gem|
  ...
  gem.add_development_dependency 'rails-observers', '~> 0'
  gem.add_development_dependency 'appraisal', '~> 0.4'
  gem.add_development_dependency 'bson_ext', '~> 1.6'
  # TODO: Most recent version still relies on active(support|model) ~> 3
  # gem.add_development_dependency 'mongo_mapper', '~> 0.12'
